...
export type Breadcrumb = { label: string; href?: string };
	export const menus: MenuGroup[] = [
		{ label: 'GENERAL', items: [
			{ text: 'Dashboards', icon: 'dashboard', children: [{ text: 'Operations', href: '/' }, { text: 'Analytics', href: '/analytics' }, { text: 'Sales', href: '/sales' }, { text: 'System health', href: '/system-health' }] },
