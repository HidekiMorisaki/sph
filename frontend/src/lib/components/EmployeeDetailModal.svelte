...
<DetailModal title="Employee detail" titleId="employee-detail-title" pretitle={employee.employeeCode} closeLabel="Close employee detail" {returnFocus} actions={footer} {onClose}>
